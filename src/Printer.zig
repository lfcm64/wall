...
const Section = types.module.Section;
...
fn printTypeSection(printer: *Printer, section: Section(.type)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printImportSection(printer: *Printer, section: Section(.import)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printFunctionSection(printer: *Printer, section: Section(.function)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printTableSection(printer: *Printer, section: Section(.table)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printMemorySection(printer: *Printer, section: Section(.memory)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printGlobalSection(printer: *Printer, section: Section(.global)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printExportSection(printer: *Printer, section: Section(.@"export")) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
fn printStartSection(printer: *Printer, section: Section(.start)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
pub fn printCodeSection(printer: *Printer, section: Section(.code)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
...
pub fn printElementSection(printer: *Printer, section: Section(.element)) !void {
    var buf: [1024]u8 = undefined;
    var file_writer = printer.file.writer(&buf);
    const writer = &file_writer.interface;
